    ...
    const renderInfoAccordian = () => {
        return <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
            <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
                <div className='text-xl'><span>Why quizzes? </span></div>
            </AccordionSummary>
            <AccordionDetails>
                <div className='p-4'>
                    ...
                    <div>An ever - evolving field like education, each learner has to learn more to stay relevant as they have access to better tools and more knowledge.
                        ...
                        <b>Engagement:- </b>Quizzes helps in engagement, which in turn helps increase the time spent on learning from the application. Moreover, as playing a quiz doesn’t seem like studying, learners involve more in their free time or to unwind, thereby adding to their learning time in a day.
                        <br /> <br />
                        <b>Retention:- </b> Participating in quizzes creates memory traces, which can influence learning outcomes in the short term. As digital quizes can be participated more than one time and repeated retrieval of these memory traces during practice leads to long - term retention of the subject.
                        <br /> <br />
