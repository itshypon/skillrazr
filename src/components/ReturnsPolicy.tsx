  ...
  return (
    <div className="text-[black]">
      ...
      <h1 className="text-xl">
        <b>Cancellation & Refunds: </b>
      </h1>
      <br />
      <br />
      <div>
        <b>Online Training For Self Placed Learning:-</b>
        <br />
        Raise refund request within 10 days of purchase of a course. Any refund
        request beyond 10 days of purchasing the course will not be accepted and
        no refund will be provided.
      </div>
      <br />
      <div>
        <b>For Instructor Led Training:- </b>
        <br />
        Raise refund request within 10 days of purchase of course. Any refund
        request beyond 10 days of purchasing the course will not be accepted and
        no refund will be provided.
      </div>
      <br />
      ...
      <div>
        ...
        days (or less) of the event, no refunds will be made. No refunds or
        credits will be available for participants who fail to attend the
        course.
        <br />
        <br />
        <b>Raising Refund Request:-</b>
        <div>
          Refund request can be initiated by reaching out to our support team
          through our{" "}
