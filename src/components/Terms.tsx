const TermsOfService = () => {
  return (
    <div className="text-[black]">
      ...
      <br />
      <br />
      This Application can be accessed through any browser on the web & mobile
      handheld devices;
      <br />
      We own the Application and any and all services, features and facilities,
      content and data provided through or in connection with the Application
      (“Services”) We are licensing you only the right to use the Application
      and the Services under the Terms.
      <br />
      You must not allow anyone else to use your copy of the Application or
      pretend to be you when using the Application. You should faithfully follow
      the Application’s instructions and not try to deliberately manipulate the
      results.
      <br />
      <br />
      <h5>
      ...
      jurisdictions, and international conventions. The Content and the Marks
      are provided on the Site “AS IS” for your information and personal use
      ...
      such registration information as necessary; (3) you agree to comply with
      ...
      the Site for any illegal or unauthorized purpose; and (7) your use of the
      ...
      another user.
      <br />
      11.use any information obtained from the Site in order to harass, abuse,
      ...
      Site.
      <br />
      21.use the Site in a manner inconsistent with any applicable laws or
      regulations.
      <br />
      <br />
      <h5>
      ...
      <br />
      In order to use the Application, you may need to sign up with your email
      and/or phone number. You may only register once with one emailaddress
      and/or phone number. By accessing the Site upon registration, we grant you
      a revocable, non-exclusive, non-transferable, limited right to install and
      use the Application on wireless electronic devices owned or controlled by
      you, and to access and use the Application on such devices strictly in
      accordance with the terms and conditions of this Application license
      contained in these Terms of Use. You shall not: (1) decompile, reverse
      ...
      WITHOUT WARNING, IN OUR SOLE DISCRETION. If we terminate or suspend your
      account for any reason, you are prohibited from registering and creating a
      new account under your name, a fake or borrowed name, or the name of any
      ...
      Website, including any third party Website made available through the
      Website;
      <br />
      ...
      failure of the Website to remain operational for any period of time.
      <br />
      <br />
      <h5>
        <b>Third Party Website</b>
      </h5>
      <br />
      The Website may include Website, content, and information owned, made
      available, or otherwise licensed by a third party (“Third Party Website”)
      or contain links to Third Party Website. You understand that Third Party
      Website are the responsibility of the third party that created or provided
      ...
      <br />
      All intellectual property rights in and to Third Party Website are the
      ...
      any provision of these Terms by you or any person using the Website on
      your behalf, a breach by you of any applicable laws, or any third-party
      claim to the extent arising from or connected with an allegation that your
      use of the Website in accordance with these Terms infringes any rights of
      a third party.
      <br />
      <br />
      <h5>
      ...
      in accordance with the laws of Singapore applicable to agreements made
      without regard to its conflict of law principles. No proceedings shall be
      brought in the courts of any other jurisdiction
      <br />
      <br />
      <h5>
      ...
      YOU TO US DURING THE USAGE PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN
      ...
      OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY
