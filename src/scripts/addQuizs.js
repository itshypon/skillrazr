...
const serviceAccount = require("../../../../Downloads/genlent-firebase-adminsdk.json");
...
const quizes = [
  {
    questions: [
      ...
      {
        options: ["Injected", "Methods", "Both A and B", "All of these"],
        title: "Props are __________ into other components",
      },
      {
        options: ["Initialization", "render", "renderComponent", "None"],
        title:
  ...
  },
  {
    questions: [
      ...
      {
        options: ["WHERE", "HAVING", "Both WHERE and HAVING", "GROUP BY"],
        title:
  ...
  },
  {
    questions: [
      ...
      },
      {
        ...
        title:
          "which of the following is ALWAYS TRUE?  Let w(n) and A(n) denote respectively, the worst case and average case running time of an algorithm executed on an input of size n.",
      },
      {
        options: [
  ...
  },
  {
    questions: [
      {
        options: ["ASCII ", "RS232C ", "2 ", "Centronics"],
        title:
          "Which of these is a standard interface for serial data transmission?",
      },
      {
        options: ["Ring ", "Local area ", "Hierarchical ", "Star"],
        title:
